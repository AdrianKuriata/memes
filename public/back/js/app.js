...
var globals = {
    dataDismiss: function dataDismiss() {
        var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

        var dismiss = document.querySelectorAll('[data-dismiss="' + type + '"]');
    ...
    validation: function validation() {
        var forms = document.querySelectorAll('.form-add-edit');
        ...
        forms.forEach(function (form) {
            form.addEventListener('submit', function (event) {
                ...
                var method = form.querySelector('[name="_method"]') ? form.querySelector('[name="_method"]').getAttribute('value') : form.method;
                ...
                axios({
                    ...
                    for (item in errors) {
                        var field = form.querySelector('[name="' + item + '"]');
...
module.exports = __webpack_require__("./resources/js/back.js");
